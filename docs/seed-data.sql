...
SELECT client_lookup.Id, organisation_seed.Name, organisation_seed.Postcode, 'seed-data'
FROM (VALUES
...
INNER JOIN dbo.FormTypes AS form_type_lookup
    ON form_type_lookup.ClientId = client_lookup.Id
...
LEFT JOIN dbo.Contacts AS contact_lookup
    ON contact_lookup.ClientId = client_lookup.Id
